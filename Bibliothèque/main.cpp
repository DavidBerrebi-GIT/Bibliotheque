...
int main() {
  ...
  BD bd1 = BD("AuteurBD1", "TitreBD1", "EditeurBD1", "ISBNBD1", 2, "Dessinateur1");
  Roman roman1 = Roman("AuteurRoman1", "TitreRoman1", "EditeurRoman1", "ISBNRoman1", 1, "Genre1");
  Recueil_poesie recueil1 =
      Recueil_poesie("AuteurRecueil1", "TitreRecueil1", "EditeurRecueil1", "ISBNRecueil1", 3, true, false);
  Theatre theatre1 = Theatre("AuteurTheatre1", "TitreTeatre1", "EditeurTheatre1", "ISBNTheatre1", 1, 18);
  Album album1 = Album("AuteurAlbum1", "TitreAlbum1", "EditeurTheatre1", "ISBNTheatre1", 1, true, false);
  ...
  BD bd2 = BD("AuteurBD2", "TitreBD2", "EditeurBD2", "ISBNBD2", 2, "Dessinateur2");
  Roman roman2 = Roman("AuteurRoman2", "TitreRoman2", "EditeurRoman2", "ISBNRoman2", 1, "Genre2");
  Roman roman3 = Roman("AuteurRoman3", "TitreRoman3", "EditeurRoman3", "ISBNRoman3", 1, "Genre3");
